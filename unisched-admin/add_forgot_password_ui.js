...
const loginModalInner = `      <h2 style="color:var(--brand);margin-bottom:8px;">Admin Login</h2>`;

const loginModalReplacement = `      <h2 style="color:var(--brand);margin-bottom:8px;" id="admin-login-title">Admin Login</h2>`;

// Replace title to have ID for easier toggling later if needed, but actually let's just add the link below the button.
const targetButton = `      <button onclick="App.adminLogin()"
